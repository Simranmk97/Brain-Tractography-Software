...
RightIndirectPathwayEdgeFile = load(uigetfile); % uigetfile will allow you to load selected files from the file explorer, just make sure you change the file viewer so that all files are included

Y = RightIndirectPathwayEdgeFile;

RightHyperDirectPathwayEdgeFile = load(uigetfile); 
...
X1 = load(uigetfile); % RightHyperDirectPathway.pts 
...
Z1 = load(uigetfile); % RightInternalCapsule.pts 
